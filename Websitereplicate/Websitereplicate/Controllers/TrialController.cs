...
namespace Websitereplicate.Controllers
{
    public class TrialController : Controller
    {
        ...
        [HttpPost]
        public ActionResult trialform(string firstName, string lastName, string email, string phone, string job, string industry)
        {
            string conString = @"Conection String";
            ...
            try
            {
                ...
                string kayit = "insert into Ftrial(firstname,lastname,email,phone,job,industry) values (@firstname,@lastname,@email,@phone,@job,@industry)";
            ...
            return RedirectToAction("FreeTrial", "Home");
